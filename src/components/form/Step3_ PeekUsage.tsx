...
export default function PeekUsage() {
  ...
  return (
    <div className="flex flex-col justify-center md:items-center gap-4 w-full">
      ...
      <div
        onClick={() => setFormState((prev) => ({ ...prev, peekUsage: "half" }))}
      ...
      <div
        onClick={() => setFormState((prev) => ({ ...prev, peekUsage: "full" }))}
